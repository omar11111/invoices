							...
							<div class="card-body">
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php $i=0?>
											@foreach ($getAllSections as $sections)
					...
					<div class="modal-body">
						...
						<div class="row row-sm">
							<div class="col-lg">
								...
								<input class="form-control" placeholder=" " name="section_name" type="text">
							</div>
						</div>
						<div class="row row-sm mg-t-20">
							<div class="col-lg">
								<label for="exampleInputEmail1">وصف القسم</label>
								<textarea class="form-control" placeholder="" name="section_des" rows="3"></textarea>
							</div>
						</div>
					</div>
